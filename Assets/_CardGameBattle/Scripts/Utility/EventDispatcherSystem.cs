...
{
    public class EventDispatcherSystem : Singleton<EventDispatcherSystem>
    {
        #region Singleton

        public static EventDispatcherSystem Instance
        {
            get
            {
                return ((EventDispatcherSystem)mInstance);
            }
            set
            {
                mInstance = value;
...
namespace iPaxStudio.Ultility
{
    ...
    /// </summary>
    public static class EventDispatcherSystemExtension
    {
        /// /// <summary>
        ...
        {
            EventDispatcherSystem.Instance.RegisterListener(eventID, callback);
        }
        ...
        {
            EventDispatcherSystem.Instance.PostEvent(eventID, param);
        }
        ...
        {
            EventDispatcherSystem.Instance.PostEvent(eventID, null);
